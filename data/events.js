    ...
    leftCol: [
      {
        type: 'qa',
        q: 'What happens here?',
        a: 'Each contestant has an 8-minute private interview with a panel of judges. You will be asked about your background, your community involvement, and your vision for the IMBB title. This is your chance to show the judges who you are beyond the stage.',
      },
      {
        type: 'checklist',
        q: 'Scoring criteria',
        items: [
          ...
          'Presence and confidence',
          'Overall presentation and grooming',
          'How authentically you shine as a bootblack',
        ],
        note: '',
      },
      {
        type: 'callout',
        label: 'Remember',
        text: 'The judges want to see you \u2014 your authentic self. Don\u2019t perform; inhabit.',
      },
    ],
    rightCol: [
      {
