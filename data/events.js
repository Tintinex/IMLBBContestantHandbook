...
const EVENTS = [
  ...
  },
  {
    id: 'event-03',
    number: '03',
    title: 'Rehearsal for Opening Ceremonies',
    day: 'Thursday Afternoon',
    time: '5:00 PM \u2013 6:00 PM',
    venue: 'Congress Plaza Hotel \u2014 Florentine Room',
    badge: 'MANDATORY',
    description: 'Rehearsal for the opening ceremonies. Contestants will practice their entrance and any required movements.',
    rememberText: 'You can wear comfortable clothes for rehearsal, but you will have a short time between rehearsal and the opening ceremonies. Plan accordingly.',
  },
  {
    id: 'event-04',
    number: '04',
    title: 'Opening Cermemonies',
    day: 'Thursday Evening',
    time: '6:30 PM \u2013 8:00 PM',
    venue: 'Florentine Room',
    badge: 'MANDATORY',
    description: 'The Opening Ceremony is the first public event of International Mr. Leather. The purpose of this event is to introduce the judges and the contestants to the public. During the Opening Ceremonies you will be lined up alphabetically by country or US state, you will be introduced and then you will draw your contestant number.',
